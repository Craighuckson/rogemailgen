...
tab_tracerwire_layout = [
    [sg.Combo(trellotw,k='twlist',enable_events=True), sg.Button('Update list',k='twupdate')],
...
tab_proposed_layout = [
    [sg.Combo(trelloprop,k='tplist',expand_x=True,enable_events=True), sg.Button('Update list',k='propupdate',enable_events=True)],
...
tab_inaccurate_layout = [
    [sg.Combo(trelloir,k='tilist',enable_events=True), sg.Button('Update list',k='irupdate',enable_events=True)],
...
layout = [
    ...
    [sg.Text("Input string"), sg.Input(k="inputstr",do_not_clear=False),sg.Button(button_text='Format',k='formatstr')],
...
while True:
    ...
    if event == 'email_inaccurate':
        Email.write_inaccurate(Email.tolist, Email.cclist,values['tn'], values['address'],values['description'])
    if event == 'makexl':
